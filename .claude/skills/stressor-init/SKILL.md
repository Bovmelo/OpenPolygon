...
argument-hint: [path_to_problem_statement_or_problem_dir] [--pid PID] [--lightcp-dir lightcp/problems] [--num-small N] [--num-large N] [--check-only] [--force-regenerate COMPONENT]
...
```text
.claude/skills/stressor-gen-small/SKILL.md
.claude/skills/stressor-vali/SKILL.md
.claude/skills/stressor-brute/SKILL.md
.claude/skills/stressor-checker/SKILL.md
.claude/skills/stressor-gen-large/SKILL.md
```
